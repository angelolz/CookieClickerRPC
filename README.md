...
### Installing the mod
To install this mod, open the Javascript console with `F12` or `Ctrl+Shift+I` and paste the following code:
```js
Game.LoadMod('https://angelolz.dev/mods/ccrpc/main.js');
```
